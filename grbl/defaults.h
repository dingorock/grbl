...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_Y_MAX_RATE 500.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 500.0 // mm/min
  #define DEFAULT_X_ACCELERATION (5.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Y_ACCELERATION (5.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  ...
  #define DEFAULT_STEP_PULSE_MICROSECONDS 150
