...
#ifdef DEFAULTS_DYNA
  // Copied from Grbl generic default settings. Settings for Dyna Mechtronics 2400 CNC Mill with Chinese Stepper Drivers
  #define DEFAULT_X_STEPS_PER_MM 1700.0
  #define DEFAULT_Y_STEPS_PER_MM 1700.0
  #define DEFAULT_Z_STEPS_PER_MM 1700.0
  #define DEFAULT_X_MAX_RATE 500.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 500.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 500.0 // mm/min
  #define DEFAULT_X_ACCELERATION (3.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Y_ACCELERATION (3.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Z_ACCELERATION (3.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_X_MAX_TRAVEL 157.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 126.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Z_MAX_TRAVEL 105.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_SPINDLE_RPM_MAX 24000.0 // rpm
  #define DEFAULT_SPINDLE_RPM_MIN 6.0 // rpm
  #define DEFAULT_STEP_PULSE_MICROSECONDS 10
